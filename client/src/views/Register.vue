    ...
    <section class="form_container">
      ...
      <el-form
        ...
        <el-form-item label="名字" prop="name">
          <el-input v-model="registerUser.name" placeholder="請輸入名字"></el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        name: [
          { required: true, message: "名字不能為空", trigger: "change" },
          { min: 2, max: 30, message: "長度在 2 到 30 個字", trigger: "blur" }
        ],
        email: [
          {
            type: "email",
